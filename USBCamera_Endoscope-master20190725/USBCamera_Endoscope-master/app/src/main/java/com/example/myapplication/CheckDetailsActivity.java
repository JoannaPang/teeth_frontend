...
public class CheckDetailsActivity extends Activity {
    ...
    private CheckDetailsActivity.MyAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if(HistoryFile.exists()){
                ...
                Log.d(TestLog, "last lineTime is:" + lastlineTime);
                HistoryLog his = new HistoryLog(lastlineTime);
                historyList.add(his);
                hisReader.close();
            }
            else{
        ...
        adapter = new MyAdapter(historyList, CheckDetailsActivity.this);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            item.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    LayoutInflater factory = LayoutInflater.from(CheckDetailsActivity.this);
